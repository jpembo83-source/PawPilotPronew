...
export async function getOverview(): Promise<SystemOverview> {
  const response = await fetch(`${BASE_URL}/overview`, { headers: await getHeaders() });
...
export async function getOrganisations(): Promise<Organisation[]> {
  const response = await fetch(`${BASE_URL}/organisations`, { headers: await getHeaders() });
...
export async function getFeatureFlags(): Promise<FeatureFlag[]> {
  const response = await fetch(`${BASE_URL}/feature-flags`, { headers: await getHeaders() });
...
export async function getModules(): Promise<ModuleConfiguration[]> {
  const response = await fetch(`${BASE_URL}/modules`, { headers: await getHeaders() });
...
export async function getDefaults(): Promise<GlobalDefaults[]> {
  const response = await fetch(`${BASE_URL}/defaults`, { headers: await getHeaders() });
...
export async function getEnvironment(): Promise<EnvironmentSettings> {
  const response = await fetch(`${BASE_URL}/environment`, { headers: await getHeaders() });
...
export async function getJobs(): Promise<BackgroundJob[]> {
  const response = await fetch(`${BASE_URL}/jobs`, { headers: await getHeaders() });
...
export async function getHealth(): Promise<SystemHealthMetrics> {
  const response = await fetch(`${BASE_URL}/health`, { headers: await getHeaders() });
