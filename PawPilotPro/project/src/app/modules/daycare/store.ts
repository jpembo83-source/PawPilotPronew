...
export const useDaycareStore = create<DaycareState>((set, get) => ({
  ...
  createBooking: async (data: Partial<DaycareBooking>) => {
    ...
    try {
      ...
      broadcastMutation('daycare', 'booking', 'created', booking.id);
      return booking;
    } catch (error: any) {
  ...
  cancelBooking: async (id: string, reason: string) => {
    ...
    try {
      ...
      broadcastMutation('daycare', 'booking', 'updated', id, { status: 'cancelled' });
      return booking;
    } catch (error: any) {
  ...
  checkIn: async (bookingId: string, data: { handover_notes?: string; warnings_acknowledged?: boolean }) => {
    ...
    try {
      ...
      broadcastMutation('daycare', 'attendance', 'created', bookingId, { action: 'check-in' });
      return result;
    } catch (error: any) {
  ...
  checkOut: async (bookingId: string, checkout_notes?: string, checkout_time?: string) => {
    ...
    try {
      ...
      broadcastMutation('daycare', 'attendance', 'updated', bookingId, { action: 'check-out' });
      return booking;
    } catch (error: any) {
