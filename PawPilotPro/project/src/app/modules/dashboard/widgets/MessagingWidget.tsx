...
import { ChatTeardrop, PaperPlaneTilt, ArrowRight, EnvelopeSimple, Phone, Warning, Clock } from '@phosphor-icons/react';
        ...
        <div className="flex items-center justify-between">
          <div>
            <CardTitle className="text-base flex items-center gap-2">
              <ChatTeardrop className="h-4 w-4 text-slate-600" />
              Messaging
            </CardTitle>
